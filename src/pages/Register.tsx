...
import { Mail, Lock, User, ArrowRight, Calendar, Chrome, Github } from 'lucide-react';
    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4 bg-gray-50/50">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">Join Evently</h1>
          <p className="text-gray-500 mt-2">Start your journey into extraordinary events</p>
        </div>
